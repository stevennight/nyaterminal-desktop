...
export const TERMINAL_THEME_PRESETS: TerminalThemePreset[] = [
  ...
  },
  {
    id: 'white',
    label: 'Nya White',
    description: '纯白背景与深色文字，适合明亮环境。',
    colors: {
      background: '#FFFFFF',
      foreground: '#24292F',
      cursor: '#0969DA',
      cursorAccent: '#FFFFFF',
      selectionBackground: '#B6D7FA',
  ...
  },
  {
    ...
    description: '经典米白低对比方案，长时间阅读更柔和。',
    colors: {
      background: '#FDF6E3',
      foreground: '#657B83',
      cursor: '#586E75',
  ...
  },
  {
    id: 'one-light',
    label: 'One Light',
    description: 'Atom 系清爽浅色方案，与 One Dark 相呼应。',
    colors: {
      background: '#FAFAFA',
      foreground: '#383A42',
      cursor: '#526EFF',
  ...
  },
  {
    ...
    description: '柔和的冷灰粉彩方案，色彩丰富但不刺眼。',
    colors: {
      background: '#EFF1F5',
      foreground: '#4C4F69',
      cursor: '#DC8A78',
